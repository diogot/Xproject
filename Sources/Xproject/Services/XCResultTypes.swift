...
// Xproject
//
// Re-exports XCResultParser types for use in PRReportService
//
...
@_exported import struct XCResultParser.TestSummary
@_exported import struct XCResultParser.XCResult
@_exported import class XCResultParser.XCResultParser
